...
class Deriver_Usecas2_Test extends PolicyExtractorTestTemplate {

    @Test
    void test1() throws IOException {
        canonicalPath = TestUtil.getTestDataPath() + "deriver" + File.separator + "usecase2";
        ...
        testobjectList.add(new TestPolicySpecification(abs, p2, new TestRecord(false), new TestRecord(false)));
